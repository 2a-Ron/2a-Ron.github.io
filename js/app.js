...
function ggQuest6() {
  ...
  while (Q6guessRemains > 0) {
    var answer6 = prompt('Guess my favorite number between 0 and 99. HINT: One of my favorite authors is Zecharia Sitchin.  In the book "The 12th Planet" many numbers are discussed, but only one is my favorite number.  You have ' + Q6guessRemains + ' attempts remaining.');
...
function ggQuest7() {
  ...
  */
  ...
  do{
    var famPersonGuess = prompt('Try and guess one of my favorite people to quote.  You have ' + Q7guessRemains + ' attempts remaining.');
